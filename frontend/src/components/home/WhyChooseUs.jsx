...
const WhyChooseUs = () => {
  return (
    <section className="py-24 bg-[#08090B] relative overflow-hidden">
      {/* Abstract Background */}
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-full h-[500px] bg-gradient-to-r from-transparent via-[#D4AF37]/5 to-transparent skew-y-6 pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            <h2 className="text-[#D4AF37] font-bold tracking-[0.3em] uppercase text-sm mb-4">The DriveX Standard</h2>
            <h3 className="text-4xl md:text-5xl font-black text-white uppercase italic tracking-tighter mb-6">
              Why Choose <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-[#D4AF37]">Us</span>
            </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group p-8 md:p-10 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl hover:bg-white/10 hover:border-[#D4AF37]/50 transition-all duration-500 relative overflow-hidden"
            >
              {/* Hover Glow */}
              <div className="absolute -top-24 -right-24 w-48 h-48 bg-[#D4AF37]/20 rounded-full blur-[50px] group-hover:bg-[#D4AF37]/40 transition-colors duration-500 pointer-events-none" />
