            ...
            return (
              ...
              >
                <div className={`w-12 h-12 rounded-full flex items-center justify-center shrink-0 ${
                  isSelected ? 'bg-[#D4AF37] text-black' : 'bg-white/10 text-white/50'
                }`}>
                  {iconMap[extra.icon] || <Check size={24} />}
                </div>
                
                <div className="flex-1">
                  <h4 className={`font-bold ${isSelected ? 'text-[#D4AF37]' : 'text-white'}`}>
                    {extra.name}
                  </h4>
                ...
                <div className="text-right shrink-0">
                  <span className={`block font-bold ${isSelected ? 'text-[#D4AF37]' : 'text-white'}`}>
                    +${extra.pricePerDay}
                  </span>
